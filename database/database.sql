...
('Super Mario Bros', 'Super Mario Bros. is a classic platformer where players control Mario as he navigates the Mushroom Kingdom to rescue Princess Peach from the villainous Bowser. The game features iconic side-scrolling levels filled with enemies, obstacles, and power-ups.', 0, 1, '090PJ3bfsG7io3zBEURDsdxYNbIjrsdXoyUbMNgz.jpg'),
('Devil May Cry', 'Devil May Cry follows the adventures of Dante, a demon hunter with supernatural abilities. Players battle hordes of demons using stylish combos and acrobatic moves, earning style points for their performance.', 0, 1, NULL),
('Ninja Gaiden', 'Ninja Gaiden is an action-adventure game series where players take on the role of a skilled ninja, Ryu Hayabusa. Players engage in fast-paced combat, solving puzzles, and exploring a dark and mystical world.', 0, 1, NULL),
('Metal Gear Rising: Revengeance', 'In this game, players control Raiden, a cyborg ninja, in a futuristic world. Combining elements of beat "em up and hack-and-slash, players engage in intense sword fights and stealthy missions.', 0, 1, NULL),
('Bayonetta', 'Bayonetta is a stylish hack-and-slash game featuring a witch named Bayonetta. Players execute graceful and brutal combos using various weapons and magical attacks while battling angels and demons.', 0, 1, NULL),
('Dark Souls', 'Dark Souls is an action RPG known for its challenging combat and deep lore. Players explore a dark fantasy world, battling formidable enemies and bosses while discovering the interconnected story.', 0, 1, NULL),
('God of War', 'God of War follows Kratos, a former Greek god, and his son Atreus in their journey through Norse mythology. Players experience intense combat, puzzle-solving, and a compelling narrative in a beautifully crafted world.', 0, 1, NULL),
('Assassins Creed Series', 'Assassin"s Creed games follow assassins throughout various historical periods. Players engage in stealthy assassinations, parkour, and combat, uncovering intricate plots involving secret organizations.', 0, 1, NULL),
...
('Hollow Knight', 'Hollow Knight is a Metroidvania-style action-adventure game set in a mysterious underground world. Players control a knight exploring intricate environments, battling enemies, and uncovering secrets, all with a beautiful hand-drawn art style.', 0, 1, NULL),
('The Legend of Zelda: Breath of the Wild', 'In this action-adventure game, players control Link, who explores the vast kingdom of Hyrule, solving puzzles, battling enemies, and uncovering the secrets of an ancient civilization.', 0, 2, NULL),
('Red Dead Redemption 2', 'Set in the American Wild West, this game follows Arthur Morgan, a member of the Van der Linde gang, as he navigates the changing times and struggles for survival. Players engage in shootouts, manage their gang, and make moral choices that affect the story.', 0, 2, NULL),
('Grim Fandango', 'Players assume the role of Manny Calavera, a travel agent in the Land of the Dead, in this noir-inspired adventure game. Manny uncovers a conspiracy that spans the afterlife, leading to a captivating journey filled with humor and mystery.', 0, 2, NULL),
('The Walking Dead: Telltale Series', 'Based on the popular comic and TV series, this game emphasizes player choices. Players control different characters in a zombie apocalypse, making decisions that affect the storyline and relationships with other survivors.', 0, 2, NULL),
('Detroit: Become Human', 'Set in a future where androids serve humans, players control multiple android characters, each with their own storylines. The game explores themes of artificial intelligence, freedom, and identity, with players making decisions that shape the outcome.', 0, 2, NULL),
('Firewatch', 'Players assume the role of a fire lookout named Henry in the Wyoming wilderness. Through radio conversations with his supervisor, Delilah, players unravel a mystery and make choices that affect the relationship between the characters.', 0, 2, NULL),
('Heavy Rain', 'A psychological thriller where players control four characters involved in the investigation of the Origami Killer, a serial murderer who uses prolonged rainfall to drown his victims. Choices made by players influence the games plot and multiple endings.', 0, 2, NULL),
('Oxenfree', 'A supernatural thriller about a group of friends who accidentally open a ghostly rift while on a trip. Players control Alex, a teenager, making decisions in dialogues that affect the story and relationships. The game features a unique radio mechanic for communication with the supernatural entities.', 0, 2, NULL),
('The Elder Scrolls V: Skyrim', 'An open-world action RPG set in the fantasy world of Tamriel. Players assume the role of the Dragonborn, a hero prophesized to save the world from dragons. Players can explore a vast, detailed world, complete quests, and develop their characters skills and abilities.', 0, 3, NULL),
...
('The Witcher 3: Wild Hunt', 'An action RPG based on the book series by Andrzej Sapkowski. Players control Geralt of Rivia, a monster hunter (Witcher), in a morally ambiguous fantasy world. The game features a rich storyline, complex characters, and a vast open world with numerous quests and activities.', 0, 3, NULL),
('Dark Souls Series', 'Known for their challenging gameplay and intricate lore, the Dark Souls games are action RPGs set in dark fantasy worlds. Players navigate treacherous environments, battle tough enemies, and engage in methodical combat. The series emphasizes exploration and discovery.', 0, 3, NULL),
('Mass Effect Series', 'A sci-fi RPG where players assume the role of Commander Shepard, tasked with saving the galaxy from various threats, including a race of sentient machines known as Reapers. Players make choices that affect the games story, relationships, and ultimate outcome.', 0, 3, NULL),
('Persona 5', 'A JRPG that combines traditional turn-based combat with life simulation elements. Players control a group of high school students who double as supernatural thieves. They balance school life, friendships, and battling supernatural forces in an alternate reality.', 0, 3, NULL),
('Diablo III', 'A dark fantasy action RPG featuring fast-paced combat and loot-driven gameplay. Players choose a character class and embark on quests to defeat hordes of enemies and powerful bosses. The game is known for its cooperative multiplayer and extensive item customization.', 0, 3, NULL),
('World of Warcraft 2', 'An MMORPG set in the high fantasy world of Azeroth. Players create characters from various races and classes, undertake quests, explore dungeons, and engage in player-vs-environment and player-vs-player activities. Its one of the most iconic and enduring MMORPGs in the world.', 0, 3, NULL),
('Pokémon Series', 'A series of RPGs where players, known as Pokémon Trainers, capture and train creatures called Pokémon. Players battle other trainers, collect Pokémon, and compete to become the Pokémon Champion. Each game introduces new Pokémon species and regions to explore.', 0, 3, NULL),
...
('Call of Duty Series', 'Call of Duty is a highly popular first-person shooter series known for its intense single-player campaigns and competitive multiplayer modes. It covers various historical periods and modern warfare scenarios.', 0, 4, NULL),
('Halo Series', 'Halo is a science fiction FPS series set in a futuristic universe. Players assume the role of Master Chief, a supersoldier, and engage in battles against alien forces. Its known for its compelling story and innovative multiplayer modes.', 0, 4, NULL),
('Counter-Strike: Global Offensive', 'Counter-Strike: Global Offensive (CS:GO) is a competitive multiplayer first-person shooter. Players join teams of terrorists and counter-terrorists and engage in objective-based missions, emphasizing strategy and precise aiming.', 0, 4, NULL),
('Overwatch', 'Overwatch is a team-based first-person shooter featuring a diverse cast of heroes, each with unique abilities. Players work together in objective-based game modes, emphasizing teamwork, hero selection, and strategic use of character skills.', 0, 4, NULL),
('Destiny 2', 'Destiny 2 combines FPS gameplay with elements of MMO and RPG. Players assume the role of Guardians, exploring different planets, battling aliens, and participating in cooperative and competitive multiplayer activities.', 0, 4, NULL),
('Gears of War Series', 'Gears of War is a third-person shooter series known for its cover-based combat mechanics. Players fight against a race of subterranean creatures using a mix of firearms and melee attacks, often with a focus on cooperative gameplay.', 0, 4, NULL),
...
('Uncharted Series', 'Uncharted is a third-person shooter series following the adventures of Nathan Drake, a treasure hunter. Players explore exotic locations, solve puzzles, and engage in intense gunfights, with a strong emphasis on cinematic storytelling.', 0, 4, NULL),
('Fortnite', 'Fortnite is a battle royale game where 100 players compete to be the last person or team standing. Players scavenge for weapons, build structures for defense, and engage in fast-paced battles in a vibrant, destructible world.', 0, 4, NULL),
('Apex Legends', 'Apex Legends is a team-based battle royale game where players select unique characters with special abilities. Teams of three players compete for victory, utilizing their chosen characters skills in a fast-paced, squad-oriented battle royale experience.', 0, 4, NULL),
('The Sims Series', 'The Sims is a life simulation game where players create and control virtual people, guiding them through various aspects of their lives, such as relationships, careers, and daily activities.', 0, 5, NULL),
('Microsoft Flight Simulator', 'A highly realistic flight simulation game that allows players to pilot a wide range of aircraft, exploring detailed and accurate representations of real-world locations.', 0, 5, NULL),
('SimCity Series', 'SimCity is a city-building simulation game where players act as mayors, building and managing cities by controlling various aspects such as zoning, infrastructure, and economic development.', 0, 5, NULL),
...
('Cities: Skylines', 'A city-building simulation game that focuses on urban planning and management. Players build and manage cities, balancing the needs of the population, infrastructure, and economy.', 0, 5, NULL),
('Euro Truck Simulator 2', 'A truck driving simulation game where players become truck drivers, transporting goods across Europe, managing their own trucking business, and experiencing the challenges of the road.', 0, 5, NULL),
('Planet Coaster', 'A theme park simulation game that allows players to design and manage their own amusement parks, including creating rides, landscaping, and managing the parks finances.', 0, 5, NULL),
('RollerCoaster Tycoon Series', 'Similar to Planet Coaster, RollerCoaster Tycoon is a classic theme park simulation game where players design, build, and manage amusement parks, including roller coasters and other attractions.', 0, 5, NULL),
('Football Manager Series', 'A sports management simulation game where players take on the role of a football (soccer) manager, controlling team tactics, transfers, and other aspects of managing a football club.', 0, 5, NULL),
('Kerbal Space Program', 'A space flight simulation game that allows players to design and manage their own space program. Players build spacecraft, launch them into orbit, and explore celestial bodies within a realistic physics-based environment.', 0, 5, NULL),
('Civilization Series', 'Civilization games are turn-based strategy games where players build and expand an empire throughout history. Players manage resources, research technologies, engage in diplomacy, and lead their civilization to victory through various means, such as science, culture, or military conquest.', 0, 6, NULL),
('StarCraft', 'StarCraft is a real-time strategy (RTS) game set in a futuristic science fiction universe. Players choose between three unique factions and compete to gather resources, build armies, and engage in strategic battles. The game emphasizes resource management, unit tactics, and base building.', 0, 6, NULL),
...
('Sid Meiers Alpha Centauri', 'Alpha Centauri is a turn-based strategy game set in a science fiction future on an alien planet. Players lead one of several factions, each with unique ideologies and technologies. The game focuses on exploration, resource management, and diplomacy, allowing players to shape the future of humanity on the new world.', 0, 6, NULL),
('Advance Wars', 'Advance Wars is a turn-based strategy series featuring colorful, grid-based battles. Players command military units on maps, capturing cities, managing resources, and engaging in tactical warfare. The series is known for its accessible gameplay and challenging strategic depth.', 0, 6, NULL),
('FIFA', 'FIFA is a popular soccer (football) simulation game series developed by EA Sports. It offers realistic gameplay, featuring teams and players from various leagues worldwide. Players can enjoy single matches, tournaments, and career modes.', 0, 7, NULL),
('NBA 2K', 'NBA 2K is a basketball simulation game series renowned for its realistic graphics and gameplay. It allows players to experience the NBA life, featuring teams, players, and arenas from the National Basketball Association.', 0, 7, NULL),
('Madden NFL', 'Madden NFL is an American football video game series developed by EA Sports. It simulates the National Football League (NFL) and offers gameplay modes like franchise management, player careers, and competitive online matches.', 0, 7, NULL),
('Rocket League', 'Rocket League combines soccer with rocket-powered cars. Players control customizable cars to score goals on the opposing team. It is a high-octane, physics-based game that offers both casual and competitive gameplay.', 0, 7, NULL),
('WWE 2K', 'WWE 2K is a wrestling simulation game based on the WWE (World Wrestling Entertainment) franchise. Players can control their favorite WWE superstars, engage in matches, and experience various game modes like career and universe mode.', 0, 7, NULL),
('Gran Turismo Series', 'Gran Turismo is a highly realistic racing simulation game series known for its attention to detail in car physics and racing tracks. It features a vast selection of cars and offers players the ability to tune and customize their vehicles.', 0, 7, NULL),
('Tony Hawks Pro Skater', 'This series focuses on skateboarding, allowing players to perform tricks, complete challenges, and explore various skate parks. Its known for its intuitive controls and level design.', 0, 7, NULL),
('EA Sports UFC Series', 'EA Sports UFC is a mixed martial arts (MMA) simulation game series featuring UFC fighters and events. Players can engage in realistic MMA fights, showcasing different fighting styles and techniques.', 0, 7, NULL),
...
('Mario Kart Series', 'Mario Kart is a kart racing game series featuring characters from the Mario franchise. Players race on colorful tracks, use power-ups, and compete against each other in both single-player and multiplayer modes.', 0, 7, NULL),
('Resident Evil', 'A survival horror franchise where players face hordes of zombies and other supernatural enemies. Known for its intense gameplay, challenging puzzles, and gripping storylines.', 0, 8, NULL),
('Silent Hill', 'Players navigate a mysterious town filled with disturbing creatures and psychological horrors. The series is renowned for its atmospheric tension and surreal, psychological narrative.', 0, 8, NULL),
...
('Amnesia: The Dark Descent', 'A first-person survival horror game emphasizing puzzle-solving and evasion of monstrous entities. Players explore a dark castle, solving mysteries while struggling to maintain sanity.', 0, 8, NULL),
('Outlast', 'Players assume the role of an investigative journalist exploring an insane asylum. Armed only with a camera, they must navigate dark corridors, avoiding deranged inmates and uncovering unsettling truths.', 0, 8, NULL),
('Alien: Isolation', 'Set in the Alien universe, players must survive against a single, relentless Xenomorph. Stealth and resourcefulness are key as players solve puzzles and avoid the alien predator.', 0, 8, NULL),
('Until Dawn', 'A narrative-driven horror game where players make choices that affect the storys outcome. Set in a remote mountain lodge, players must keep a group of young adults alive amid various horror movie scenarios.', 0, 8, NULL),
('Layers of Fear', 'An exploration-focused horror game centered around a disturbed painter unraveling the secrets of his mansion. The environment changes dynamically, creating a haunting and immersive experience.', 0, 8, NULL),
('Soma', 'A science fiction horror game exploring themes of consciousness and identity. Players navigate an underwater facility, solving puzzles and making moral decisions that impact the storys direction.', 0, 8, NULL),
('PT (Playable Teaser)', 'Although not a full game, PT is a famous demo that was meant to be a teaser for the canceled Silent Hills project. It takes place in a looping, eerie corridor where players experience surreal and terrifying events.', 0, 8, NULL),
('Tetris', 'Tetris is a classic tile-matching puzzle game where players manipulate falling blocks to create complete horizontal lines, which then disappear. The game requires quick thinking and spatial arrangement skills.', 0, 9, NULL),
('Portal Series', 'Portal and Portal 2 are first-person puzzle-platform games where players use a portal gun to create linked portals between two locations. The games challenge players with intricate puzzles that involve physics and creative problem-solving.', 0, 9, NULL),
('The Witness', 'The Witness is a first-person puzzle game set on a mysterious island. Players explore the island and solve puzzles that are integrated into the environment, gradually uncovering the games narrative while enhancing their puzzle-solving skills.', 0, 9, NULL),
('Braid', 'Braid is a puzzle-platformer game that features time manipulation as its core mechanic. Players control the protagonist Tim, solving puzzles by manipulating time, rewinding and altering events to progress through the game.', 0, 9, NULL),
('Limbo', 'Limbo is a dark, atmospheric puzzle-platformer game where players control a young boy on a quest to find his sister. The game features challenging puzzles and a unique monochromatic art style, creating a haunting and immersive experience.', 0, 9, NULL),
('Myst', 'Myst is a graphic adventure puzzle game where players explore surreal and visually stunning worlds. Players solve puzzles by interacting with objects and deciphering clues, uncovering the games intricate storyline and unraveling mysteries.', 0, 9, NULL),
...
('Monument Valley', 'Monument Valley is a visually captivating puzzle-adventure game where players guide a character named Ida through impossible architectural structures. Players manipulate the environment to create optical illusions and solve perspective-based puzzles.', 0, 9, NULL),
('Catherine', 'Catherine is a puzzle-platformer and dating simulation game. Players navigate intricate tower puzzles during the night, dealing with themes of commitment, relationships, and infidelity during the day, making moral choices that affect the games outcome.', 0, 9, NULL),
('Lumines', 'Lumines is a music-themed puzzle game where players rotate and align blocks of different colors to form squares. The game features a dynamic soundtrack and a synchronized visual experience, with blocks and background changing in time with the music.', 0, 9, NULL),
('World of Warcraft', 'Developed by Blizzard Entertainment, World of Warcraft (WoW) is one of the most iconic MMORPGs. Set in the high-fantasy world of Azeroth, players can choose from various races and classes, embark on quests, explore dungeons, and engage in player versus player (PvP) battles.', 0, 10, NULL),
('Final Fantasy XIV', 'A Realm Reborn: Published by Square Enix, Final Fantasy XIV is a MMORPG set in the fantasy world of Eorzea. Players can explore a rich storyline, participate in group dungeons and raids, and engage in large-scale player-driven events. The game is known for its deep narrative and engaging PvE content.', 0, 10, NULL),
...
('The Elder Scrolls Online', 'Based on the popular Elder Scrolls series, this MMO by ZeniMax Online Studios allows players to explore the continent of Tamriel. Players can join factions, complete quests, explore dungeons, and participate in PvP battles in the massive open world of the Elder Scrolls universe.', 0, 10, NULL),
('Star Wars: The Old Republic', 'Set in the Star Wars universe and developed by BioWare, The Old Republic (SWTOR) offers an immersive MMO experience with fully voiced dialogue, cinematic storytelling, and player choices that impact the games narrative. Players can choose to align with the Sith Empire or the Galactic Republic and experience epic Star Wars adventures.', 0, 10, NULL),
('Runescape', 'Developed and published by Jagex, Runescape is a browser-based MMORPG that has been running since 2001. It offers a vast open world, various skills to train, quests to complete, and a player-driven economy. Players can choose between Old School Runescape (based on the games 2007 version) or the modern version with updated graphics and gameplay.', 0, 10, NULL),
('Black Desert', 'Developed by Pearl Abyss, Black Desert Online is known for its stunning graphics and action-oriented combat system. Players can engage in trading, fishing, crafting, and large-scale siege warfare. The game features a sandbox world where players can shape the games economy and politics.', 0, 10, NULL),
('Destiny', 'Developed by Bungie, Destiny is a hybrid MMO and first-person shooter set in a sci-fi universe. Players can participate in cooperative and competitive gameplay, explore various planets, complete raids, and engage in intense PvP battles. The game offers a mix of PvE and PvP experiences.', 0, 10, NULL),
('The Division 2', 'Developed by Ubisoft Massive, Tom Clancys The Division 2 is an online action RPG set in a post-apocalyptic Washington D.C. Players can team up with others to explore the open world, complete missions, engage in PvP combat, and participate in endgame content, including raids and strongholds.', 0, 10, NULL);
