            ...
            <div class="top-answer">
                ...
                <div class="answer-details">
                    ...
                    <div class="answer-content"> 
                        ...
                        <ul>
                            <li> <a href="#" class="purple">{{ $topAnswer->creator->name }}</a> answered {{ calculateTimePassed($topAnswer->create_date) }}</li>
                            <li> Modified {{ calculateTimePassed($topAnswer->create_date) }}</li>
